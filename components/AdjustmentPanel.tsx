...
const AdjustmentPanel: React.FC<AdjustmentPanelProps> = ({ onApplyAdjustment, isLoading }) => {
  ...
  const presets = [
    { name: '模糊背景', prompt: '应用真实的景深效果，使背景模糊，同时保持主体清晰对焦。' },
    { name: '增强细节', prompt: '轻微增强图像的清晰度和细节，使其看起来更自然。' },
    { name: '暖色调', prompt: '调整色温，使图像呈现更温暖的黄金时刻风格光线。' },
    { name: '影棚光', prompt: '为主要对象添加引人注目的专业影棚灯光。' },
  ];
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-center text-gray-300">应用专业级调整</h3>
      ...
      <input
        ...
        placeholder="或描述一个调整（例如，'把背景换成森林'）"
