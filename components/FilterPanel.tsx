...
const FilterPanel: React.FC<FilterPanelProps> = ({ onApplyFilter, isLoading }) => {
  ...
  const presets = [
    { name: '合成波', prompt: '应用鲜艳的80年代合成波美学，带有霓虹品红和青色的光晕，以及微妙的扫描线效果。' },
    { name: '动漫风', prompt: '赋予图片鲜明的日本动漫风格，具有大胆的轮廓、赛璐珞着色和饱和的色彩。' },
    { name: 'LOMO', prompt: '应用LOMO相机风格的交叉处理胶片效果，具有高对比度、过饱和的色彩和明显的暗角。' },
    { name: '赛博故障', prompt: '将图像转换为具有数字故障效果和色差的未来主义全息投影。' },
  ];
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-center text-gray-300">应用创意滤镜</h3>
      ...
      <input
        ...
        placeholder="或描述一个自定义滤镜（例如 '80年代复古风'）"
